        ...
        <Card className="p-8 bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-200">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    {/* Email Card */}
                    <div className="bg-white rounded-lg p-6 shadow-sm border border-green-100 hover:shadow-md transition-shadow">
                        <div className="flex flex-col items-center text-center space-y-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">admin@arsip.local</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-lg p-6 shadow-sm border border-green-100 hover:shadow-md transition-shadow">
                        <div className="flex flex-col items-center text-center space-y-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">+62 XXX-XXXX-XXXX</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-lg p-6 shadow-sm border border-green-100 hover:shadow-md transition-shadow">
                        <div className="flex flex-col items-center text-center space-y-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">Senin - Jumat<br />08:00 - 16:00</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="mt-8 pt-6 border-t border-green-200">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-gray-600">
                        <div>
                            <h4 className="font-semibold text-gray-900 mb-2">📧 Format Email Pertanyaan:</h4>
                        ...
                        <div>
                            <h4 className="font-semibold text-gray-900 mb-2">⚡ Tips Mendapat Respons Cepat:</h4>
                            <ul className="space-y-1 list-disc list-inside">
