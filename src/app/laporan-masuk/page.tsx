...
export default function LaporanMasukPage() {
    ...
    const handleExportPDF = () => {
        ...
        try {
            ...
            exportToPDF(data, "incoming", filters)
    ...
    const handleExportExcel = () => {
        ...
        try {
            ...
            exportToExcel(data, "incoming", filters)
    ...
    const handlePrint = () => {
        ...
        try {
            ...
            printReport(data, "incoming", filters)
        } catch {
        ...
        <MainLayout>
            <div className="space-y-6">
                ...
                <div>
                    ...
                    <p className="text-gray-600 mt-1">Kelola dan ekspor laporan surat masuk</p>
                </div>
