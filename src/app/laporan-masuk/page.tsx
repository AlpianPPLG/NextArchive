    ...
    return (
        <MainLayout>
            <div className="space-y-6">
                {/* Header */}
                <div>
                    <h1 className="text-3xl font-bold">Laporan Surat Masuk</h1>
                    <p className="text-muted-foreground mt-1">Kelola dan ekspor laporan surat masuk yang telah diarsipkan</p>
                </div>
